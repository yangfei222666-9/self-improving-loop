...
Not yet. `v0.1.1` has 59 tests, cross-platform CI, a rollback path, JSONL/SQLite trace storage, and a first Yijing strategy. It is early and should be tested around your own agent before production use.
